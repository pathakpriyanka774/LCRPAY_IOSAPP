    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <Text style={styles.paragraph}>
          This Privacy Policy describes how LUCREWAY PAY PVT LTD and its a
          liates (collectively "LUCREWAY PAY PVT LTD, we, our, us") collect,
          use, share, protect or otherwise process your information/ personal
          data through our website https://lcrpay.com/ (hereinafter referred to
          as Platform). Please note that you may be able to browse certain
          sections of the Platform without registering with us.
          {"\n"}
          ...
          product/service o ered on the Platform, you expressly agree to be
        ...
        <Text style={styles.paragraph}>
          ...
          proof of identity or address.{"\n"} Some of the sensitive personal data may
          ...
          LUCREWAY PAY PVT LTD seeking any personal data like debit/credit card
        ...
        <Text style={styles.paragraph}>
          ...
          troubleshoot problems; inform youabout online and o line o ers,
        ...
        <Text style={styles.paragraph}>
          ...
          entities, our other corporate entities, and a liates to provide you
          access to the services and products o ered by them. These entities and
          a liates may market to you as a result of such sharing unless you
          ...
          services and products o ered to you, to comply with our legal
          ...
          enforcement o ces, third party rights owners, or others in the good
        ...
        <Text style={styles.paragraph}>
          ...
          security guidelines to protect it against unauthorised access and o er
          the use of a secure server. However, the transmission of information
          is not completely secure for reasons beyond our control. By using the
        ...
        <Text style={styles.paragraph}>
          ...
          would result in you losing all information related to your account.
          You may also write to us at the contact information provided below to
          assist you with these requests. We may in event of any pending
          grievance, claims, pending shipments or any other services we may
          refuse or delay deletion of the account. Once the account is deleted,
          you will lose access to the account. We retain your personal data
        ...
        <Text style={styles.paragraph}>
          ...
          other corporate entities, a liates, lending partners, technology
          ...
          by writing to the Grievance O cer at the contact information provided
          ...
          requests before acting on our request. However, please note that your
        ...
        <Text style={styles.paragraph}>
          Company: LUCREWAY PAY PVT LTD
          {"\n"}402, Fourth Floor, SG Alpha Tower 2, Sector 9, Vasundhra, Ghaziabad, Uttar Pradesh-201012
{"\n"}Contact: care@lcrpay.com | 01169311284
